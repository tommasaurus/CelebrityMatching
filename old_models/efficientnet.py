...
model = nn.Sequential(*list(efficientnet_b0.children())[:-1])  # Remove final classification layer
model.eval()
...
#     transforms.CenterCrop(299),  # Ensure the input image size is 299x299
#     transforms.ToTensor(),
#     transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]),
# ])
...
input_image_paths = ['images/abella.jpg', 'images/kylie.jpg', 'images/margot.webp', 'images/abella2.jpg']
